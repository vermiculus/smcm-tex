% arara: pdflatex
% arara: pdflatex
% arara: clean: { files: [ introduction.aux, introduction.log ] }
% arara: clean: { files: [ introduction.toc, introduction.out ] }
% arara: clean: { files: [ introduction.bcf, introduction.run.xml ] }
